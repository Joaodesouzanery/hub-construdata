...
const SETORES: SetorDefinicao[] = [
  {
    ...
    projetoKeywords: ["Saneamento"],
    licitacaoKeywords: ["Saneamento", "esgoto", "água", "saneamento", "ETE", "ETA", "adutora"],
    noticiaKeywords: ["saneamento", "esgoto", "água tratada", "sabesp", "aegea", "brk", "copasa", "sanepar"],
  },
  {
    id: "energia",
    label: "Energia",
    ...
    projetoKeywords: ["Energia"],
    licitacaoKeywords: ["Energia", "energia", "elétrica", "eólica", "solar", "hidrelétrica", "transmissão", "subestação"],
    noticiaKeywords: ["energia", "eólica", "solar", "hidrelétrica", "transmissão", "neoenergia", "cpfl", "eletronorte"],
  },
  {
    id: "rodovias",
    label: "Infraestrutura Rodoviária",
    cor: "#f97316",
    corTailwind: "text-orange-500",
    ...
    projetoKeywords: ["Infraestrutura", "Rodovia"],
    licitacaoKeywords: ["Infraestrutura", "rodovia", "pavimentação", "duplicação", "ponte", "viaduto", "asfalto"],
    noticiaKeywords: ["rodovia", "concessão rodoviária", "pedágio", "ccr", "ecorodovias", "arteris", "duplicação"],
  },
  {
    id: "ferrovias",
    label: "Ferrovias",
    ...
    segmentoKeywords: ["Ferrovia", "Ferrovias"],
    projetoKeywords: ["Ferrovia", "Ferrovias"],
    licitacaoKeywords: ["Ferrovias", "ferrovia", "ferroviária", "trem", "metrô"],
    noticiaKeywords: ["ferrovia", "ferroviária", "trem", "metrô", "trilho"],
  },
  {
    id: "habitacao",
    label: "Habitação",
    ...
    projetoKeywords: ["Habitação", "Habitacao"],
    licitacaoKeywords: ["habitacional", "habitação", "moradia", "Minha Casa", "unidades habitacionais"],
    noticiaKeywords: ["habitação", "habitacional", "minha casa", "moradia", "cyrela", "mrv", "direcional"],
  },
  {
    id: "residuos",
    label: "Resíduos Sólidos",
    cor: "#f43f5e",
    corTailwind: "text-rose-500",
    ...
    projetoKeywords: ["Resíduos", "Residuos"],
    licitacaoKeywords: ["Residuos", "resíduos", "aterro sanitário", "coleta seletiva", "lixo", "reciclagem"],
    noticiaKeywords: ["resíduos", "aterro", "reciclagem", "coleta seletiva", "orizon", "estre"],
  },
];
